...
import ug.go.agriculture.MAAIF_Extension.daes.grm.Review;
...
public class PhotoUpload extends AppCompatActivity implements ImageContract.View, FileUploaderContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a1 = intent.getStringExtra("district");
        a2 = intent.getStringExtra("subcounty");
        a3 = intent.getStringExtra("parish");
        a4 = intent.getStringExtra("type");
        a5 = intent.getStringExtra("mode");
        a6 = intent.getStringExtra("age");
        a7 = intent.getStringExtra("nature");
        a8 = intent.getStringExtra("gender");
        a9 = intent.getStringExtra("phone");
        a10 = intent.getStringExtra("date");
        a11 = intent.getStringExtra("reference");
        a12 = intent.getStringExtra("description");
        a13 = intent.getStringExtra("actions");
        a14 = intent.getStringExtra("settled");
        a15 = intent.getStringExtra("feedback");
        a16 = intent.getStringExtra("anonymous");
        a50 = intent.getStringExtra("grievance_id");

        super.onCreate(savedInstanceState);
        setContentView(R.layout.photo_upload_egrm);
        ...
        name.setText("Date: " + a10);
        subcounty.setText("Subcounty: ");
        xgender.setText("District : " + a1);
        phone.setText("Date of grievance: " + a10);
        parish.setText("Past actions: " + a13);
        spousename.setVisibility(View.GONE);
        ref.setText("Description : " + a12);
        xhasspouse.setVisibility(View.GONE);
        spousephone.setText("Reference Number: "+ a11);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.upload_file_progress:
                ...
                mUploaderPresenter.onFileSelected(mImagePresenter.getImage(), a50, photoCategory);
                break;
            default:
                break;
        }
