...
public class Main extends AppCompatActivity
    ...
    private TextView nav_questions_count,nav_questions_count_text;
    private TextView nav_answered_count,nav_questions_answered_count_text;
    private TextView nav_pending_count,nav_questions_pending_count_text;
    private NavigationView navView;
    private FloatingActionButton btnPendingFarmerQns;
    private FloatingActionButton btnReviewAnsweredQns;
    private FloatingActionButton btnSubmitNewQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(ug.go.agriculture.MAAIF_Extension.daes.advisory.Main.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ug.go.agriculture.MAAIF_Extension.daes.advisory.Main.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_INTERNET);
        }
        if (ContextCompat.checkSelfPermission(ug.go.agriculture.MAAIF_Extension.daes.advisory.Main.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ug.go.agriculture.MAAIF_Extension.daes.advisory.Main.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_INTERNET);
        }
        ...
        if (user_category.equals("Farmer")) {
            setContentView(R.layout.menu_farmer_advisory);
        } else {
            setContentView(R.layout.activity_drawer_main_advisory);
        }
        ...
        nav_questions_count = (TextView) findViewById(R.id.nav_questions_count);
        nav_questions_count_text = (TextView) findViewById(R.id.nav_questions_count_text);
        nav_pending_count = (TextView) findViewById(R.id.nav_questions_pending_count);
        nav_questions_pending_count_text = (TextView) findViewById(R.id.nav_questions_pending_count_text);
        nav_answered_count = (TextView) findViewById(R.id.nav_questions_answered_count);
        nav_questions_answered_count_text = (TextView) findViewById(R.id.nav_questions_answered_count_text);
        ...
        btnSubmitNewQuestion = (FloatingActionButton) findViewById(R.id.btnSubmitNewQuestion);
        ...
        //Get total questions
        int totalQuestions =  mDBHelper.getCountAllQuestions();
        String tQuestions =  String.valueOf(totalQuestions);

        //Get total answered questions
        int totalAnsweredQuestions =  mDBHelper.getCountAnsweredQuestions();
        String tAnsweredQuestions =  String.valueOf(totalAnsweredQuestions);

        //Get total unanswered questions
        int totalUnansweredQuestions =  mDBHelper.getCountUnAnsweredQuestions();
        String tUnansweredQuestions =  String.valueOf(totalUnansweredQuestions);
        ...
        nav_answered_count.setText(tAnsweredQuestions);
        nav_questions_count.setText(tQuestions);
        nav_pending_count.setText(tUnansweredQuestions);
        ...
        btnPendingFarmerQns.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(),
                        ug.go.agriculture.MAAIF_Extension.daes.advisory.Questions.class);
                startActivity(i);
                finish();
            }
        });

        btnSubmitNewQuestion.setOnClickListener(new View.OnClickListener() {

            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(),
                        ug.go.agriculture.MAAIF_Extension.daes.advisory.Form.class);
                startActivity(i);
                finish();
            }
        });
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(ug.go.agriculture.MAAIF_Extension.daes.advisory.Main.this, Login.class);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(ug.go.agriculture.MAAIF_Extension.daes.advisory.Main.this,
