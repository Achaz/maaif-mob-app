...
public class Main extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener  {
    ...
    private FloatingActionButton btnReportGrivance;
    private FloatingActionButton btnSavedGrievances;
    private FloatingActionButton btnTrackGrivances;
    ...
    private TextView total_grievances;
    private TextView synced_grievances;
    private TextView unsynced_grievances;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(ug.go.agriculture.MAAIF_Extension.daes.grm.Main.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ug.go.agriculture.MAAIF_Extension.daes.grm.Main.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_INTERNET);
        }
        if (ContextCompat.checkSelfPermission(ug.go.agriculture.MAAIF_Extension.daes.grm.Main.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ug.go.agriculture.MAAIF_Extension.daes.grm.Main.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_INTERNET);
        }
        ...
        if (user_category.equals("Farmer")) {
            ...
            setContentView(R.layout.activity_drawer_main_grm);
        }
        ...
        btnReportGrivance = (FloatingActionButton) findViewById(R.id.btnReportGrivance);
        btnSavedGrievances = (FloatingActionButton) findViewById(R.id.btnSavedGrievances);
        btnTrackGrivances = (FloatingActionButton) findViewById(R.id.btnTrackGrivances);
        btnGoBack = (FloatingActionButton) findViewById(R.id.btnGoBack);

        total_grievances = (TextView) findViewById(R.id.all_grievances);
        synced_grievances = (TextView) findViewById(R.id.synced_grievances);
        unsynced_grievances = (TextView) findViewById(R.id.unsynced_grievances);
        grievancesStats();
        ...
        btnReportGrivance.setOnClickListener(new View.OnClickListener() {
        ...
        btnSavedGrievances.setOnClickListener(new View.OnClickListener() {
        ...
        btnTrackGrivances.setOnClickListener(new View.OnClickListener() {
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(ug.go.agriculture.MAAIF_Extension.daes.grm.Main.this, Login.class);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(ug.go.agriculture.MAAIF_Extension.daes.grm.Main.this,
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Log.d("Else part", "Something else here...");
