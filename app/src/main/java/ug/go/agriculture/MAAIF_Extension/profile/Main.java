package ug.go.agriculture.MAAIF_Extension.profile;
...
public class Main extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // setContentView(R.layout.activity_drawer_main_profile);
        ...
        if (ContextCompat.checkSelfPermission(ug.go.agriculture.MAAIF_Extension.profile.Main.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ug.go.agriculture.MAAIF_Extension.profile.Main.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, REQUEST_INTERNET);
        }
        if (ContextCompat.checkSelfPermission(ug.go.agriculture.MAAIF_Extension.profile.Main.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(ug.go.agriculture.MAAIF_Extension.profile.Main.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_INTERNET);
        }
        ...
        if (user_category.equals("Farmer")) {
            Log.d("Here:", "farmer");
            setContentView(R.layout.menu_farmer_profile);
        } else {
            setContentView(R.layout.activity_drawer_main_profile);
        }
    ...
    private void logoutUser() {
        ...
        Intent intent = new Intent(ug.go.agriculture.MAAIF_Extension.profile.Main.this, Login.class);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(ug.go.agriculture.MAAIF_Extension.profile.Main.this,
