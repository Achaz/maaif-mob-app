...
import ug.go.agriculture.MAAIF_Extension.daes.profiling.farmergroup.NetworkStateChecker;
...
public class Review extends Activity {
    ...
    private TextView farmer_groups_count;
    private TextView no_farmer_groups_text;
    /*
     * this is the url to our webservice
     * make sure you are using the ip instead of localhost
     * it will not work if you are using localhost
     * */
    public static final String URL_SAVE_NAME = "https://extension.agriculture.go.ug/api/saveFarmerGroup.php";
    public static final String URL_SYNC_NEW_EOIs = "https://extension.agriculture.go.ug/api/saveFarmerGroup.php";
    ...
    private FarmerGroupAdapter farmerGroupAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.farmer_groups_sync);
        ...
        farmerGroups = new ArrayList<>();

        farmer_groups_count = (TextView) findViewById(R.id.registered_farmer_groups_count);
        no_farmer_groups_text = (TextView) findViewById(R.id.no_farmer_groups_text);
     ...
     * */
    private void loadFarmerGroups() {
        farmerGroups.clear();
        Cursor cursor = db.getFarmerGroups();
        int count = cursor.getCount();
        farmer_groups_count.setText("Farmer groups count: " + String.valueOf(count));

        if (count == 0) {
            no_farmer_groups_text.setText("No farmer groups registered yet...");
        } else {
            no_farmer_groups_text.setVisibility(View.GONE);
            if (cursor.moveToFirst()) {
                do {
                    @SuppressLint("Range") FarmerGroup farmerGroup = new FarmerGroup(
                    ...
                    farmerGroups.add(farmerGroup);
                } while (cursor.moveToNext());
            }

            farmerGroupAdapter = new FarmerGroupAdapter(this, R.layout.names, farmerGroups);
