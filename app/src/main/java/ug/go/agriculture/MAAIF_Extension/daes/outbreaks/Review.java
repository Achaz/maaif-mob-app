...
public class Review extends android.app.Activity {
    ...
    private TextView outbreaks_crises_count;
    private TextView no_outbreaks_crises_text;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.outbreak_crisis_sync);
        ...
        outbreaks_crises_count = (TextView) findViewById(R.id.registered_outbreaks_crises_count);
        no_outbreaks_crises_text = (TextView) findViewById(R.id.no_outbreaks_crises_text);
    ...
    private void loadNames() {
        ...
        outbreaks_crises_count.setText("Outbreaks/crises count: " + String.valueOf(count));

        if (count == 0) {
            no_outbreaks_crises_text.setText("No outbreaks/crises registered yet...");
        } else {
            no_outbreaks_crises_text.setVisibility(View.GONE);
