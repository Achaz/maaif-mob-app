...
public class Review extends android.app.Activity {
    ...
    private TextView no_activities_text;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        activities_count = (TextView) findViewById(R.id.registered_activities_count);
        no_activities_text = (TextView) findViewById(R.id.no_activities_text);
...
//        buttonSave.setOnClickListener(this);
    ...
    private void loadNames() {
        ...
        activities_count.setText("Activities count: " + String.valueOf(count));

        if (count == 0) {
            no_activities_text.setText("No activities registered yet...");
        } else {
            no_activities_text.setVisibility(View.GONE);
