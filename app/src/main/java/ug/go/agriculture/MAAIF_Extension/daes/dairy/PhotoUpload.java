...
public class PhotoUpload extends AppCompatActivity implements ImageContract.View, FileUploaderContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a19 = (String) intent.getStringExtra("id");
        String activityx = intent.getStringExtra("activity");
        String entreprizex = intent.getStringExtra("entreprize");
        String districtx = intent.getStringExtra("district");
        String subcountyx = intent.getStringExtra("subcounty");
        String createdx = intent.getStringExtra("created");
        String topicx = intent.getStringExtra("topic");
        String groupx = intent.getStringExtra("group");
        String benx = intent.getStringExtra("ben");
        String contactx = intent.getStringExtra("contact");
        String refx = intent.getStringExtra("ref");
        String activitytypex = intent.getStringExtra("type");



        super.onCreate(savedInstanceState);
        setContentView(R.layout.photo_upload_diary);
        ...
        name.setText(activityx);
        subcounty.setText("Topic: " +topicx);
        xgender.setText("District : "+districtx);
        phone.setText("Subcounty/Village: " +subcountyx);
        parish.setText("Entreprize: " +entreprizex);
        spousename.setText("Total Beneficiaries: " + benx);
        ref.setText("Reference Contact : " + contactx);
        xhasspouse.setText("Group :"+ groupx);
        spousephone.setText("Reference: "+ refx);
        village.setText(activitytypex);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.upload_file_progress:
                ...
                mUploaderPresenter.onFileSelected(mImagePresenter.getImage(), a19, photoCategory);
                break;
    ...
    private void selectImage() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ug.go.agriculture.MAAIF_Extension.daes.dairy.PhotoUpload.this);
    ...
    public void displayImagePreview(File mFile) {
        Glide.with(ug.go.agriculture.MAAIF_Extension.daes.dairy.PhotoUpload.this).load(mFile).apply(new RequestOptions().centerCrop().circleCrop().placeholder(R.drawable.camera)).into(userProfilePhoto);
    }
