...
public class Main extends AppCompatActivity
    ...
    private FloatingActionButton btnReviewFarmerGroups;
    private FloatingActionButton btnGoBack;
    private TextView total_farmer_groups;
    private TextView synced_farmer_groups;
    private TextView unsynced_farmer_groups;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_drawer_main_profiling_farmergroup);
        ...
        btnReviewFarmerGroups = (FloatingActionButton) findViewById(R.id.btnReviewFarmerGroups);
        btnGoBack = (FloatingActionButton) findViewById(R.id.btnGoBack);

        total_farmer_groups = (TextView) findViewById(R.id.total_farmer_groups);
        synced_farmer_groups = (TextView) findViewById(R.id.synced_farmer_groups);
        unsynced_farmer_groups = (TextView) findViewById(R.id.unsynced_farmer_groups);
        farmerGroupsStats();
        ...
        //if (yourString != null && !yourString.isEmpty()) {
            // Do something with yourString
        //} else {
            // Handle the case when yourString is null or empty
        //}
        ...
        btnReviewFarmerGroups.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(),
                        Review.class);
                startActivity(i);
    ...
    // get farmer groups stats
    private void farmerGroupsStats(){
        SQLiteHandler handler = new SQLiteHandler(this);
         Map<String, Object> farmer_groups_stats = handler.farmerGroupsStats().get(0);
         int all_farmer_groups = (int) farmer_groups_stats.get("all");
         int synced_groups = (int) farmer_groups_stats.get("synced");
         int unsynced_groups = (int) farmer_groups_stats.get("unsynced");

        total_farmer_groups.setText(String.valueOf(all_farmer_groups));
        synced_farmer_groups.setText(String.valueOf(synced_groups));
        unsynced_farmer_groups.setText(String.valueOf(unsynced_groups));
    }
    ...
    private void initToolbar() {
        ...
        actionBar.setTitle("Farmer Groups Profiling");
    }
